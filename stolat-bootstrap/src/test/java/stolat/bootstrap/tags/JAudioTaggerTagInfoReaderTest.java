...
class JAudioTaggerTagInfoReaderTest {
    ...
    private void initialiseTagMocks(Tag mockTag, AudioHeader mockAudioHeader,
                                    ...
                                    List<String> artistMbidTags, List<String> artistNameTags, String albumArtistName) {
        ...
        lenient().when(mockTag.getFirst(FieldKey.ALBUM_ARTIST)).thenReturn(albumArtistName);
    }

    @Test
    void shouldGetTrackWithCorrectTags() {
        final Album album = new Album(ALBUM_MBID.toString(), ALBUM_NAME, List.of(ARTIST_MBID.toString()), List.of(ARTIST_NAME), ARTIST_NAME);
        ...
        initialiseTagMocks(mockFirstTag, mockFirstAudioHeader,
                FIRST_TRACK_MBID.toString(), Integer.toString(DISC_NUMBER), Integer.toString(FIRST_TRACK_NUMBER), FIRST_TRACK_NAME,
                FIRST_TRACK_LENGTH, ALBUM_MBID.toString(), ALBUM_NAME, List.of(ARTIST_MBID.toString()), List.of(ARTIST_NAME), ARTIST_NAME);
    ...
    void shouldGetMultipleArtistTrackWithCorrectTags() {
        var displayArtist = ARTIST_NAME + " & " + ANOTHER_ARTIST_NAME;
        final Album album = new Album(ANOTHER_ALBUM_MBID.toString(), ANOTHER_ALBUM_NAME, List.of(ARTIST_MBID.toString(), ANOTHER_ARTIST_MBID.toString()), List.of(ARTIST_NAME, ANOTHER_ARTIST_NAME), displayArtist);
        final Track expected = new Track(
        ...
        initialiseTagMocks(mockThirdTag, mockThirdAudioHeader,
                THIRD_TRACK_MBID.toString(), Integer.toString(DISC_NUMBER), Integer.toString(THIRD_TRACK_NUMBER), THIRD_TRACK_NAME,
                THIRD_TRACK_LENGTH, ANOTHER_ALBUM_MBID.toString(), ANOTHER_ALBUM_NAME, List.of(ARTIST_MBID.toString(), ANOTHER_ARTIST_MBID.toString()), List.of(ARTIST_NAME, ANOTHER_ARTIST_NAME), displayArtist);
    ...
    void shouldGetTrackBatchWithCorrectTags() {
        ...
        initialiseTagMocks(mockSecondTag, mockSecondAudioHeader,
                SECOND_TRACK_MBID.toString(), Integer.toString(DISC_NUMBER), Integer.toString(SECOND_TRACK_NUMBER), SECOND_TRACK_NAME,
                SECOND_TRACK_LENGTH, ALBUM_MBID.toString(), ALBUM_NAME, List.of(ARTIST_MBID.toString()), List.of(ARTIST_NAME), ARTIST_NAME);
    ...
    void shouldNotGetTrackWhenTrackLengthInvalid() {
        initialiseTagMocks(mockFirstTag, mockFirstAudioHeader,
                FIRST_TRACK_MBID.toString(), Integer.toString(DISC_NUMBER), Integer.toString(FIRST_TRACK_NUMBER), FIRST_TRACK_NAME,
                -1, ALBUM_MBID.toString(), ALBUM_NAME, List.of(ARTIST_MBID.toString()), List.of(ARTIST_NAME), ARTIST_NAME);
    ...
    void shouldNotGetTrackWhenAlbumMbidNull() {
        initialiseTagMocks(mockFirstTag, mockFirstAudioHeader,
                FIRST_TRACK_MBID.toString(), Integer.toString(DISC_NUMBER), Integer.toString(FIRST_TRACK_NUMBER), FIRST_TRACK_NAME,
                FIRST_TRACK_LENGTH, null, ALBUM_NAME, List.of(ARTIST_MBID.toString()), List.of(ARTIST_NAME), ARTIST_NAME);
    ...
    void shouldNotGetTrackWhenAlbumMbidEmpty() {
        initialiseTagMocks(mockFirstTag, mockFirstAudioHeader,
                FIRST_TRACK_MBID.toString(), Integer.toString(DISC_NUMBER), Integer.toString(FIRST_TRACK_NUMBER), FIRST_TRACK_NAME,
                FIRST_TRACK_LENGTH, "", ALBUM_NAME, List.of(ARTIST_MBID.toString()), List.of(ARTIST_NAME), ARTIST_NAME);
    ...
    void shouldNotGetTrackWhenAlbumMbidInvalid() {
        initialiseTagMocks(mockFirstTag, mockFirstAudioHeader,
                FIRST_TRACK_MBID.toString(), Integer.toString(DISC_NUMBER), Integer.toString(FIRST_TRACK_NUMBER), FIRST_TRACK_NAME,
                FIRST_TRACK_LENGTH, "1234", ALBUM_NAME, List.of(ARTIST_MBID.toString()), List.of(ARTIST_NAME), ARTIST_NAME);
    ...
    void shouldNotGetTrackWhenAlbumNameNull() {
        initialiseTagMocks(mockFirstTag, mockFirstAudioHeader,
                FIRST_TRACK_MBID.toString(), Integer.toString(DISC_NUMBER), Integer.toString(FIRST_TRACK_NUMBER), FIRST_TRACK_NAME,
                FIRST_TRACK_LENGTH, ALBUM_MBID.toString(), null, List.of(ARTIST_MBID.toString()), List.of(ARTIST_NAME), ARTIST_NAME);
    ...
    void shouldNotGetTrackWhenAlbumNameEmpty() {
        initialiseTagMocks(mockFirstTag, mockFirstAudioHeader,
                FIRST_TRACK_MBID.toString(), Integer.toString(DISC_NUMBER), Integer.toString(FIRST_TRACK_NUMBER), FIRST_TRACK_NAME,
                FIRST_TRACK_LENGTH, ALBUM_MBID.toString(), "", List.of(ARTIST_MBID.toString()), List.of(ARTIST_NAME), ARTIST_NAME);
    ...
    void shouldNotGetTrackWhenArtistMbidEmpty() {
        initialiseTagMocks(mockFirstTag, mockFirstAudioHeader,
                FIRST_TRACK_MBID.toString(), Integer.toString(DISC_NUMBER), Integer.toString(FIRST_TRACK_NUMBER), FIRST_TRACK_NAME,
                FIRST_TRACK_LENGTH, ALBUM_MBID.toString(), ALBUM_NAME, List.of(""), List.of(ARTIST_NAME), ARTIST_NAME);
    ...
    void shouldNotGetTrackWhenArtistMbidInvalid() {
        initialiseTagMocks(mockFirstTag, mockFirstAudioHeader,
                FIRST_TRACK_MBID.toString(), Integer.toString(DISC_NUMBER), Integer.toString(FIRST_TRACK_NUMBER), FIRST_TRACK_NAME,
                FIRST_TRACK_LENGTH, ALBUM_MBID.toString(), ALBUM_NAME, List.of("1234"), List.of(ARTIST_NAME), ARTIST_NAME);
